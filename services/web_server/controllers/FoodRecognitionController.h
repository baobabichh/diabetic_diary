...
public:
  ...
  ADD_METHOD_TO(FoodRecognitionController::edit_result, "/edit_result", Get);
  ...
  void edit_result(const HttpRequestPtr &req, std::function<void(const HttpResponsePtr &)> &&callback) const;
